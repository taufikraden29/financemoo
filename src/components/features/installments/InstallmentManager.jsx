        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-blue-100 text-xs md:text-sm font-medium">Total Hutang</span>
                ...
                <p className="text-lg md:text-xl font-bold">{formatCurrency(statistics.totalDebt)}</p>
                <p className="text-blue-100 text-xs">{statistics.activeInstallments} aktif</p>
            </div>

            <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-green-100 text-xs md:text-sm font-medium">Sudah Dibayar</span>
                    <div className="bg-white/20 p-2 rounded-lg">
                        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-lg md:text-xl font-bold">{formatCurrency(statistics.totalPaid)}</p>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-600 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-orange-100 text-xs md:text-sm font-medium">Terlambat</span>
                    <div className="bg-white/20 p-2 rounded-lg">
                        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-lg md:text-xl font-bold">{overdueInstallments.length}</p>
                <p className="text-orange-100 text-xs">cicilan terlambat</p>
            </div>

            <div className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-purple-100 text-xs md:text-sm font-medium">Akan Datang</span>
                    <div className="bg-white/20 p-2 rounded-lg">
                        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-lg md:text-xl font-bold">{upcomingInstallments.length}</p>
                <p className="text-purple-100 text-xs">30 hari ke depan</p>
            </div>
        </div>
    );
            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6">
                    ...
                    <div className="bg-blue-50 rounded-xl p-4 mb-4">
                        ...
                        <p className="text-2xl font-bold text-blue-900">{formatCurrency(selectedPayment.amount)}</p>
                    </div>
    ...
    return (
        <div className="p-4 md:p-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Cicilan Hutang</h2>
